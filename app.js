  ...
  events: {
    'e-19': {
      ...
      target: {
        selector: '.card--light',
        originalId:
          '617dbbf4d7ed7f5ac184a57a|2937c980-81eb-6724-38b2-48d078f75d89',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-27': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.blog_post-image',
        originalId:
          '617dbbf4d7ed7f5ac184a57a|05033bbf-693c-6c4c-52b6-f39dfc5501e3',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-29': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.blog_latest-image',
        originalId:
          '617dbbf4d7ed7faf7b84a58c|56b3b270-2b7d-ffc5-0055-f12800213860',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-31': {
      ...
      target: {
        ...
        originalId:
          '617dbbf4d7ed7faf7b84a58c|147a64af-546c-e71c-5d7f-00dd6f7a2621',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-32': {
      ...
      action: {
        ...
        instant: false,
        config: { actionListId: 'shrinkOut', autoStopEventId: 'e-31' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.container--dark',
    ...
    'e-33': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.pricing_card',
        originalId:
          '617dbbf4d7ed7f8ebe84a591|9523ec08-cc08-c00b-8b74-cc82bf077415',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-35': {
      ...
      target: {
        selector: '.card_video',
        originalId:
          '617dbbf4d7ed7f8ebe84a591|13f1763d-6ad6-c2f7-3369-40b4bca9ef65',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-41': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.card_icon--white',
        originalId:
          '617dbbf4d7ed7f7b8284a592|25356f8d-650c-5088-9a1c-a9767a659890',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-45': {
      ...
      target: {
        ...
        originalId:
          '617dbbf4d7ed7f8ebe84a591|32d16528-8017-80ef-5612-fdecd76ed375',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-55': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.float--pulse-01',
        originalId:
          '617dbbf4d7ed7f7b8284a592|c036b7a8-d918-a425-daed-bd0a98e55765',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-59': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.float--pulse-02',
        originalId:
          '617dbbf4d7ed7f7b8284a592|34de99cc-91ea-f264-4724-a8d397213beb',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-67': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.float--pulse-03',
        originalId:
          '617dbbf4d7ed7f7b8284a592|eb6ca77e-6e33-637d-644a-40e8635df9c2',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-69': {
      ...
      target: {
        selector: '.card_image',
        originalId:
          '617dbbf4d7ed7f5ac184a57a|5813bc44-1a32-325d-0597-90de9bdb2f1b',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-85': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '617dbbf4d7ed7f5ac184a57a|82f811d5-086b-8aab-3db9-a3e19c739299',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-87': {
      ...
      target: {
        selector: '.nav_link',
        originalId:
          '617dbbf4d7ed7f5ac184a57a|82f811d5-086b-8aab-3db9-a3e19c7392e6',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-89': {
      ...
      target: {
        selector: '.nav_cta',
        originalId:
          '617dbbf4d7ed7f5ac184a57a|82f811d5-086b-8aab-3db9-a3e19c7392f1',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-91': {
      ...
      mediaQueries: ['medium', 'small', 'tiny'],
      target: {
        selector: '.nav_toggle-icon--open',
        originalId:
          '617dbbf4d7ed7f5ac184a57a|82f811d5-086b-8aab-3db9-a3e19c73929e',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-93': {
      ...
      mediaQueries: ['medium', 'small', 'tiny'],
      target: {
        selector: '.nav_toggle-icon--close',
        originalId:
          '617dbbf4d7ed7f5ac184a57a|82f811d5-086b-8aab-3db9-a3e19c7392a2',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-97': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.cg--about_min-2',
        originalId: 'e739f7b3-849f-a0ab-1b66-801a77664d58',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-103': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.cg--about-prompt',
        originalId: 'eccfa031-ecc0-dcc8-641a-5d13e1030c82',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-105': {
      ...
      action: {
        ...
        instant: false,
        config: { actionListId: 'pop', autoStopEventId: 'e-106' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.cards-image',
        originalId:
          '617dbbf4d7ed7f5ac184a57a|000c968a-6683-411a-b2ec-ace6ba9aea6f',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-108': {
      ...
      action: {
        ...
        actionTypeId: 'POP_EFFECT',
        instant: false,
        config: { actionListId: 'pop', autoStopEventId: 'e-109' },
      },
      mediaQueries: ['tiny', 'small', 'medium', 'main'],
      target: {
        selector: '.card--light',
        originalId:
          '617dbbf4d7ed7f5ac184a57a|9fe8fcb9-796c-44ea-74eb-87d914e5da49',
        appliesTo: 'CLASS',
      },
      targets: [
        {
          selector: '.card--light',
          originalId:
            '617dbbf4d7ed7f5ac184a57a|7c8b2eec-2dcd-baae-f9ad-c6401677d304',
          appliesTo: 'CLASS',
        },
      ],
      config: {
    ...
    'e-110': {
      ...
      action: {
        ...
        actionTypeId: 'POP_EFFECT',
        instant: false,
        config: { actionListId: 'pop', autoStopEventId: 'e-111' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '617dbbf4d7ed7f5ac184a57a|aede2fe2-138d-8271-b8e6-38c3cf5c53d2',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-112': {
      ...
      action: {
        ...
        actionTypeId: 'POP_EFFECT',
        instant: false,
        config: { actionListId: 'pop', autoStopEventId: 'e-113' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '617dbbf4d7ed7f5ac184a57a|b30b23ec-b938-1764-9505-aa8d141c47f7',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-114': {
      ...
      action: {
        ...
        actionTypeId: 'POP_EFFECT',
        instant: false,
        config: { actionListId: 'pop', autoStopEventId: 'e-115' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '617dbbf4d7ed7f5ac184a57a|ab6e5038-7ccc-acf7-e382-f5bdb4a7a93e',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-116': {
      ...
      action: {
        ...
        actionTypeId: 'POP_EFFECT',
        instant: false,
        config: { actionListId: 'pop', autoStopEventId: 'e-117' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '617dbbf4d7ed7f5ac184a57a|a467c71a-a5cb-86fa-5c88-ff7691bd2e08',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-118': {
      ...
      action: {
        ...
        actionTypeId: 'POP_EFFECT',
        instant: false,
        config: { actionListId: 'pop', autoStopEventId: 'e-119' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '617dbbf4d7ed7f5ac184a57a|ee388bb0-f6e1-58d6-e951-4826fc1da2a2',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: '617dbbf4d7ed7f7b8284a592|c036b7a8-d918-a425-daed-bd0a98e55765',
                },
                value: 0,
                unit: '',
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: '.nav_menu',
                  selectorGuids: ['2f012e92-ca17-b9ad-6ab3-4ef8a1092af7'],
                },
                xValue: 0.95,
                yValue: 0.95,
                locked: true,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  selector: '.nav_toggle-icon--close',
                  selectorGuids: ['72bfe3ed-5b9f-278b-6532-b3d53d864847'],
                },
                zValue: 0,
                xUnit: 'DEG',
                yUnit: 'DEG',
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  selector: '.nav_toggle-icon--open',
                  selectorGuids: ['c0eed879-ae45-4fed-e605-0f5b0648c20e'],
                },
                value: 'flex',
              },
            },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: '.cg--about-prompt',
                  selectorGuids: ['8a7d37bb-76ec-e545-ecfe-d0f5b8d904e3'],
                },
                value: 'flex',
              },
            },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: '.cg--about-bar',
                  selectorGuids: ['25b9683d-f846-7e3d-76ec-43f0dfb75842'],
                },
                value: 'none',
              },
            },
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: 'e739f7b3-849f-a0ab-1b66-801a77664d5b',
                },
                value: 'flex',
              },
            },
